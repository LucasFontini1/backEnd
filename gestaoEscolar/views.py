...
from .serializers import AlunoSerializer, MatriculaSerializer, TurmaSerializer, NotaSerializer, FrequenciaSerializer, DisciplinaSerializer, ProfessoresSerializer, CursoSerializer, CoordenadorSerializer
