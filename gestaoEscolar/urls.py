...
from .views import AlunoViewSet, MatriculaViewSet, TurmaViewSet, NotaViewSet, FrequenciaViewSet, DisciplinaViewSet, ProfessoresViewSet, CursoViewSet, CoodenadorViewSet
